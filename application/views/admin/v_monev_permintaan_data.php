...
<div class="row mb-4">
    ...
    <div class="col-xl-4 col-md-4 mb-4">
        ...
        <!-- Main Content - REARRANGED LAYOUT -->
<div class="row mt-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center p-2 rounded hover-bg-light">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <small class="text-muted"><?= round($persen_terpenuhi, 1) ?>%</small>
                                    </div>
                                </div>
                                <div class="text-end">
                                    <span class="text-sm font-weight-bold d-block"><?= $status_permohonan['terpenuhi'] ?></span>
                                    <span class="text-xs text-muted">Permohonan</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center p-2 rounded hover-bg-light">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <small class="text-muted"><?= round($persen_proses, 1) ?>%</small>
                                    </div>
                                </div>
                                <div class="text-end">
                            ...
                            <div class="d-flex justify-content-between align-items-center p-2 rounded hover-bg-light">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <small class="text-muted"><?= round($persen_ditolak, 1) ?>%</small>
                                    </div>
                                </div>
                                <div class="text-end">
                    ...
                    <div class="col-12">
                        <div class="space-y-2">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="progress flex-grow-1" style="height: 8px;">
                                    <div class="progress-bar" role="progressbar" 
                                         style="width: <?= $persen_ditolak ?>%; background-color: #DC2626;"></div>
                                </div>
    ...
    <!-- TUTUP CARD STATUS PERMOHONAN INFORMASI -->
    ...
    <!-- TUTUP CARD STATUS PEMOHON -->
</div>
<!-- TUTUP ROW -->

<!-- Via Permohonan Table - PINDAH KE BAWAH -->
<div class="row mt-4">
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Via</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" style="width: 80px;">Jumlah</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center" style="width: 70px;">Persen</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Di bagian Modal Detail Via - tambahkan progress bar untuk Ditolak -->
<div class="row mt-3">
    <div class="col-12">
        <div class="card">
